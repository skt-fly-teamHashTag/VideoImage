...
def caption_expansion(thumb_imgs):
    ...
    parser.add_argument('--load_path', type=str, default='./pretrained/rf_model.pth')
    ...
    input_images = []
    for i in range(len(thumb_imgs)):
      img = thumb_imgs[i][0]
      img = PIL_Image.fromarray(img)
      preprocess_pil_image = transf_1(img)
    ...
    for i in range(len(input_images)):
        ...
        captioning_output.append(pred)                                                
        
    return captioning_output
