    ...
    for i in range(len(background_output)):
        if len(background_output[i]["labels"]) != 0:
            ...
            if pt - tmp_img_width // 2 < 0:
                bg[:, i * tmp_img_width:(i+1) * tmp_img_width] = background_img[i][:, :tmp_img_width]
            elif pt + tmp_img_width // 2 > tmp_width:
                bg[:, i * tmp_img_width:(i+1) * tmp_img_width] = background_img[i][:,tmp_img_width * -1:]
            else:
                ...
                bg[:, i * tmp_img_width:(i+1) * tmp_img_width] = background_img[i][:, pt - tmp_img_width // 2:pt + tmp_img_width // 2 + k]
