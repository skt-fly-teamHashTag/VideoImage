...
def evaluate(model, val_loader, nms_thresh, device):
    ...
    with torch.no_grad():
        for test_key, seq, _, cps, n_frames, nfps, picks, user_summary in val_loader:
            ...
            # print("input_shape, ", seq_torch.shape)
...
def main():
    ...
    for split_path in args.splits:
        ...
        for split_idx, split in enumerate(splits):
            ...
            # ckpt_path = '../models/pretrain_ab_basic/checkpoint/summe.yml.1.pt'
            print("load state dict from : ", str(ckpt_path))
            ...
            print(f"evaluate,, split_idx {split_idx} ")
