...
def main():
    ...
    for split_path in args.splits:
        ...
        for split_idx, split in enumerate(splits):
            ...
            ckpt_path = data_helper.get_ckpt_path(model_dir, split_path, split_idx) # dsNet 학습시킨 ckpt 파일 저장 경로 
            fscore = trainer(args, split, ckpt_path) # 해당 split 데이터에 대해 학습 & 모델 저장 
